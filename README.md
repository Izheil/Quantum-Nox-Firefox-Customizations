...
- __Multirows*.uc.js__: Fix issues with the resizer and tab selection show in FF154+.

### Pre-last update: 14/05/2026

Files updated:

- __Multirows*.uc.js__: Fix deprecated ownerGlobal property on nodes in FF152+.
