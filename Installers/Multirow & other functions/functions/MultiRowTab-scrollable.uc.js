...
// @include        main
// @compatibility  Firefox 147 to Firefox 155.0a1 (2026-07-27)
    ...
    */
    ...
    if (useResizer) {
        ...
        // FF71+
            ...
            tabsScrollbox = document.querySelector("#tabbrowser-tabs > arrowscrollbox").shadowRoot.querySelector("scrollbox");
        } 
